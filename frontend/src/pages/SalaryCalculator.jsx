...
const SalaryCalculator = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F7FAFC] text-[#111827] pt-28 pb-24 px-4 sm:px-6 lg:px-8 font-sans animate-fadeIn">
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div>
          <button
            onClick={() => navigate("/")}
            className="inline-flex items-center gap-2 text-[15px] font-medium text-[#6B7280] hover:text-[#2F80ED] transition-colors mb-4 group"
          >
          ...
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#EDF5FF] border border-[#2F80ED]/20 text-[#2F80ED] text-[13px] font-semibold uppercase tracking-wider mb-3">
                <Calculator className="w-4 h-4" />
                <span>Compensation Intelligence</span>
              </div>
              <h1 className="text-[36px] sm:text-[44px] font-bold tracking-tight text-[#111827]">
                Tech Salary Calculator
              </h1>
            </div>
            <p className="text-[15px] text-[#6B7280] max-w-xs sm:text-right">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 bg-white border border-[#E5E7EB] rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 sm:p-10 space-y-8">
            
            <div className="pb-4 border-b border-[#E5E7EB]">
              <h2 className="text-[20px] font-bold text-[#111827] flex items-center gap-2.5">
            ...
            <div className="space-y-3">
              ...
              <select
                ...
                className="w-full px-5 py-3.5 bg-white border border-[#E5E7EB] rounded-[18px] text-[#111827] text-[16px] shadow-[0_2px_10px_rgb(0,0,0,0.02)] focus:outline-none focus:ring-2 focus:ring-[#2F80ED]/40 focus:border-[#2F80ED] transition-all cursor-pointer"
              >
                {ROLES_DATA.map((role) => (
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[15px] font-bold text-[#2F80ED] bg-[#EDF5FF] px-3 py-1 rounded-full border border-[#2F80ED]/20">
              ...
              <input
                ...
                className="w-full h-2 bg-[#E5E7EB] rounded-lg appearance-none cursor-pointer accent-[#2F80ED]"
              />
              <div className="flex justify-between text-[12px] font-semibold text-[#9CA3AF]">
            ...
            <div className="space-y-3">
              ...
              <div className="relative flex items-center">
                ...
                <select
                  ...
                  className="w-full pl-12 pr-5 py-3.5 bg-white border border-[#E5E7EB] rounded-[18px] text-[#111827] text-[16px] shadow-[0_2px_10px_rgb(0,0,0,0.02)] focus:outline-none focus:ring-2 focus:ring-[#2F80ED]/40 focus:border-[#2F80ED] transition-all cursor-pointer"
                >
                  {LOCATIONS.map((loc) => (
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-3 gap-3 p-1.5 bg-[#F7FAFC] border border-[#E5E7EB] rounded-[18px]">
                  ...
                  <button
                    ...
                    className={`py-2.5 rounded-[14px] text-[14px] font-semibold transition-all ${
                      equityValuation === tier
                        ? "bg-white text-[#2F80ED] shadow-[0_2px_10px_rgb(0,0,0,0.04)] border border-[#E5E7EB]"
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-white border border-[#E5E7EB] rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 relative overflow-hidden">
              <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-[#2F80ED] to-[#56CCF2]" />

              <div className="flex items-center justify-between mb-6 pb-4 border-b border-[#E5E7EB]">
                <span className="text-[14px] font-semibold text-[#6B7280] uppercase tracking-wider flex items-center gap-2">
              ...
              {/* Big Salary Numbers */}
              <div className="mb-6">
                <div className="text-[32px] sm:text-[38px] font-extrabold text-[#111827] tracking-tight leading-none flex items-center">
                  ₹{calculatedMedian.toLocaleString("en-IN")}
                  <span className="text-[16px] font-medium text-[#6B7280] ml-1">/ year</span>
                </div>
                <p className="text-[14px] text-[#6B7280] mt-2 font-medium">
                  Expected Range: <span className="font-semibold text-[#111827]">₹{calculatedMin.toLocaleString("en-IN")}</span> – <span className="font-semibold text-[#111827]">₹{calculatedMax.toLocaleString("en-IN")}</span>
                </p>
              </div>

              {/* Monthly Breakdown Boxes */}
              <div className="grid grid-cols-2 gap-3 p-4 bg-[#F7FAFC] border border-[#E5E7EB] rounded-[18px] mb-6">
                <div>
                  <p className="text-[12px] text-[#6B7280] font-semibold uppercase">Gross Monthly</p>
                  <p className="text-[17px] font-bold text-[#111827] mt-0.5">₹{estimatedMonthlyGross.toLocaleString("en-IN")}</p>
                </div>
                <div>
            ...
            <div className="bg-white border border-[#E5E7EB] rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 space-y-4">
              ...
              <ul className="space-y-3 text-[14px] text-[#6B7280]">
                <li className="flex items-start gap-2.5">
                  ...
                  <span><strong>Remote Advantage:</strong> Global remote offers currently align with Tier-1 city medians.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#22C55E] shrink-0 mt-0.5" />
                  <span><strong>AI Skill Premium:</strong> Machine Learning experience adds an average 18% compensation uplift.</span>
                </li>
              </ul>
            </div>
